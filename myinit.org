...
#+BEGIN_SRC elisp
  ...
  ((string-equal system-type "darwin") ; Mac OS X
   (progn
     ...
     (server-start)
     ;; The below might not be useful
     ;; (setq TeX-command-default "latexmk")
     ;; (setenv "PATH" "/opt/homebrew/bin/:$PATH" t)
     ;; (setq exec-path (append exec-path '("/opt/homebrew/bin/:$PATH")))
     (message "Mac OS X")))
...
#+BEGIN_SRC elisp
  ...
  :custom
  (cnfonts-personal-fontnames '(("Arial" "PragmataPro Mono Liga" "Go Mono" "Fira Code" "Ubuntu Mono" "JetBrains Mono")
